...
BlockLibrary::BlockLibrary()
{
	...
	uint32_t* data = new uint32_t[(textureFiles.size() + 6) * texturePixels()];
    ...
    glTexImage3D(GL_TEXTURE_CUBE_MAP_ARRAY, 0, GL_RGBA8, m_resolution, m_resolution, textureFiles.size() + 6, 0, GL_RGBA, GL_UNSIGNED_BYTE, data);
