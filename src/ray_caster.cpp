...
bool castRay(const Camera& camera, const ChunkManager& chunkManager, Coordinate& currentBlock,
             Coordinate& lastBlock) {
    ...
    do {
        ...
        if (glm::length(current - camera.eye) > MAX_TARGET_DISTANCE) return false;
